...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'bg-indigo-700': style == 'success', 'bg-red-700': style == 'danger', 'bg-yellow-700': style == 'warning', 'bg-gray-600': style != 'success' && style != 'danger' && style != 'warning'}"
            style="display: none;"
            x-show="show && message"
    ...
    <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 'bg-indigo-800': style == 'success', 'bg-red-800': style == 'danger', 'bg-yellow-800': style == 'warning' }">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-indigo-800 focus:bg-indigo-800': style == 'success', 'hover:bg-red-800 focus:bg-red-800': style == 'danger', 'hover:bg-yellow-800 focus:bg-yellow-800': style == 'warning'}"
                    aria-label="Dismiss"
